...
```
 ...
 ### ✔ Allow configuring the iperf server globally and by organization with a setting,
...
### ✔ To Implement a lock (1 iperf check per server at time)
